...
LANG_CODE = "es-MX"  # Mantener el idioma español mexicano
TTS_VOICE = "es-MX-Neural2-D"  # Voz femenina neural
TTS_VOICE_FALLBACK = "es-MX-Standard-C"  # Voz femenina estándar (respaldo)
